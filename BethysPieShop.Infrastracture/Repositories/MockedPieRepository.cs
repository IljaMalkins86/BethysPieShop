...
namespace BethysPieShop.Infrastracture.Repositories;

public class MockedPieRepository : IPieRepository
{
    private readonly ICategoryRepository _categoryRepository;

    public MockedPieRepository(ICategoryRepository categoryRepository)
    {
    ...
    {
        var allPies = await GetAllAsync();
        return allPies.Where(p => p.IsPieOfTheWeek)?.ToList();
    }

    public Task<List<Pie>?> SearchAsync(string query)
    {
